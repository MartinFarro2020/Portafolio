const Contact = () => {
  return (
    <main className="bg-black -mt-[250px] sm:mt-[50px]" id="contact">
     <section className="grid" >
      <section className="grid mt-[350px] mb-[200px] mx-auto justify-center items-center sm:mt-[100px] sm:mb-[300px] ">
        <div className="grid text-center w-[250px] h-[400px] bg-zinc-800 rounded-3xl items-center sm:w-[890px] sm:h-[370px]">
